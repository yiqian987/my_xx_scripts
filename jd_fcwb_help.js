...
!(async () => {
    ...
    try{res = await getAuthorShareCode('https://gitee.com/KingRan521/JD-Scripts/raw/master/shareCodes/fcwb.json111');}catch (e) {}
     if(!res){res = [];}
...
async function takeRequest(functionId,bodyInfo){
    let  url = `https://api.m.jd.com/?functionId=${functionId}&body=${encodeURIComponent(bodyInfo)}&t=${Date.now()}&appid=activities_platform&client=H5&clientVersion=1.0.0&h5st=20220310003901887%3B1821832650438868%3B8dd95%3Btk02wa9cf1c7918nTKJT5UPS4sj5gIKYbeEvy9%2BzrgUqm1JmXW1hz7rMnqs6hxyOG2hj4s%2Fc081LawKCJ6gcrWeSVitc%3Bc7523a482f94c95bae9f3f2d8e9d4c1c17ea868c18505d1d5c44caceae7fceb6%3B3.0%3B1646843941887`;
    //let  url = ``;
    const headers = {
        'Host' : `api.m.jd.com`,
